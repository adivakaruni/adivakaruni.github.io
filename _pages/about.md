...
3.  <span style="color:#2ec4b6">**Uncovering Retail Trading in Bitcoin: The Impact of COVID-19 Stimulus Checks**</span>  
...
2.  <span style="color:#2ec4b6">**The Lightning Network: Turning Bitcoin into Money**</span>  
      with [Peter Zimmerman](https://sites.google.com/view/peter-zimmerman/)  
...
1.  <span style="color:#2ec4b6">**Lending When Relationships Are Scarce: The Role of Information Spread via Bank Networks**</span>  
...
2.  <span style="color:#2ec4b6">**Fintech Lending Under Austerity**</span>  
...
1.  <span style="color:#2ec4b6">**How does Mandatory Disclosure affect Firm Growth? Evidence from Firms that Lose their JOBS Exemptions**</span>  
...
1. <span style="color:#2ec4b6">**Input Technology and Airline Pricing**</span>  
      with [Paula Navarro](https://www.nhh.no/en/employees/faculty/paula-navarro-sarmiento/)  

2. <span style="color:#2ec4b6">**Market Reactions to Gendered Speech Patterns**</span>  
...
3. <span style="color:#2ec4b6">**Ex Ante Price Discovery during IPO Bookbuilding**</span>  
